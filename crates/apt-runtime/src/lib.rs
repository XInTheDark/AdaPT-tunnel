...
//! configuration loading, tunnel/TUN wiring, H2 public-session orchestration,
//! and thin operational helpers for the client and combined server daemon.
#![allow(missing_docs)]
...
pub use quic::load_certificate_der;
pub use runtime::{
    ...
    respond_api_sync_ug3_request_with_extension_builder, run_client, run_client_with_hooks,
